...
from estate_management import app
...
class AdminUsersView(ModelView):
    ...
    column_filters = [User.role, User.gender]
    ...
    column_create_list = (User.firstname, User.lastname, User.dateofbirth, User.username, User.password_hash, User.streetname, User.housenumber, User.flatnumber, User.gender, User.telephone, User.role)



class AdminGuestsView(ModelView):
    column_type_formatters = dict()
    column_list = ('staffs', 'services  ', 'firstname')

admin.add_view(AdminUsersView(User, db.session, name='Users'))
admin.add_view(AdminGuestsView(Guest, db.session, name='Guests'))
admin.add_view(AdminModelView(Code, db.session, name='Codes'))
...
@adminapp.route('/gencode', methods=['GET','POST'])
def gencode():
...
@adminapp.route("/createUser", methods=["GET", "POST"])
def createUser():
...
#OCCUPANTS PROFILE
@adminapp.route("/profile", methods=['GET','POST'])
@login_required
def profile():
...
#GUARDS PROFILE
@adminapp.route("/guardprofile/", methods=['GET','POST'])
@login_required
def guardprofile():
...
@adminapp.route("/viewprofile/<int:user_id>", methods = ['GET','POST'])
@login_required
...
@adminapp.route("/updateUser/<int:user_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteUser/<int:user_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/guest", methods=["GET", "POST"])
@login_required
def createGuest():
...
@adminapp.route("/updateGuest/<int:guest_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteGuest/<int:guest_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/staff", methods=["GET", "POST"])
@login_required
def createStaff():
...
@adminapp.route("/updateStaff/<int:staff_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteStaff/<int:staff_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/service", methods=["GET", "POST"])
@login_required
def createService():
...
@adminapp.route("/updateService/<int:service_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteService/<int:service_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route('/buySubscription', methods=['GET','POST'])
@login_required
def buySubscription():
...
@adminapp.route('/subscriptionlist')
@login_required
...
@adminapp.route('/payment', methods=['POST'])
@login_required
def payment():
...
@adminapp.route('/createEnquiry', methods=['GET','POST'])
@login_required
def createEnquiry():
    form = EnquiryForm()
...
@adminapp.route("/updateEnquiry/<int:enquiry_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteEnquiry/<int:enquiry_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route('/createNews', methods=['GET','POST'])
@login_required
def createNews():
    form = NewsForm()
...
@adminapp.route("/updateNews/<int:news_id>", methods=["GET", "POST"])
@login_required
...
@adminapp.route("/deleteNews/<int:news_id>", methods=["GET", "POST"])
@login_required
